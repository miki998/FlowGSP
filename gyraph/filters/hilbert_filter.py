...
from gyraph.utils import np, deepcopy
...
class HilbertFilter(SpectralFilter):
    ...
    def hilbert_filter(self) -> np.ndarray:
        """
    ...
    def analytical_signal(self, signal: np.ndarray) -> np.ndarray:
        """
    ...
    def graph_instant_frequency(self, signal: np.ndarray) -> np.ndarray:
        """
    ...
    def demodulating_by_division(self, signal: np.ndarray) -> np.ndarray:
