"""
Logging configuration for Gyraph.

This module provides centralized logging configuration for the Gyraph library
...
def setup_logger(
    ...
    ----------
    name : str, optional
        Name of the logger. Default is "gyraph".
...
def get_logger(name: str = "gyraph") -> logging.Logger:
    """
    ...
    Examples
    --------
    >>> logger = get_logger("gyraph.graphs")
